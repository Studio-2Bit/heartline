...
export default function Settings() {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      setTimeout(() => { setShowPwForm(false); setPwMessage(''); setPwData({ currentPassword: '', newPassword: '', confirmPassword: '' }); }, 2000);
    } catch (err: any) {
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Download system activity reports</p>
            </div>
          </div>

          <div className="p-4 bg-gray-50 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-1">Download Weekly Report</h3>
            <p className="text-sm text-gray-500 mb-3">Includes all system logs with type, action, user, details and timestamps</p>
            <button
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Manage admin account security</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
              ...
              {!showPwForm ? (
                ...
                <div className="space-y-2 max-w-sm">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => { setShowPwForm(false); setPwMessage(''); }}
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-500 mb-3">Add new administrator accounts to manage the system</p>
