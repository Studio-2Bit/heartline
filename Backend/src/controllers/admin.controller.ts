...
export const getPendingDonors = async (req: Request, res: Response) => {
  try {
    const users = await User.find({ role: 'donor', isVerified: false });
...
export const getPendingHospitals = async (req: Request, res: Response) => {
  try {
    const users = await User.find({ role: 'hospital', isVerified: false });
...
export const verifyUser = async (req: Request, res: Response) => {
  try {
    ...
    // If hospital, also mark hospital profile as verified
